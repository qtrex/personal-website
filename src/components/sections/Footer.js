    ...
    return (
        ...
        <div className="container-fluid center-text ">
            ...
            <div className="row icon-row">
                ...
                <div className="col icon-edit">
                    <a className="nav_item icons" href="https://www.instagram.com/chex_mixx_/">
                ...
                <div className="col icon-edit">
                    <a className="nav_item icons" href="https://github.com/qtrex">
            ...
            <div className="row copyright-spacing">
                <div className="col">
                    <p className="center-text copyright-edit">Copyright © {currentYear} Quixari Jones</p>
                </div>
            </div>
        </div>
    );
